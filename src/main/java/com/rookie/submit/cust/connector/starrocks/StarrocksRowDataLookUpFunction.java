 ...
 * RowData}.
 */
public class StarrocksRowDataLookUpFunction extends TableFunction<RowData> {
    private static final long serialVersionUID = 1008611L;
    private static final Logger LOG = LoggerFactory.getLogger(StarrocksRowDataLookUpFunction.class);
    ...
    public StarrocksRowDataLookUpFunction(String[] fieldNames, String[] keyNames,
                                          DataType producedDataType, StarrocksOption options, RowType rowType) {
...
//                statement = lookupKeyRowConverter.toExternal(keyRow, statement);
                ...
                try {
                    ...
                    LOG.error(
                            "Starrocks connection is not valid, and reestablish connection failed", exception);
    ...
    public void close() throws Exception {
        ...
        if (statement != null) {
            try {
                ...
                LOG.info("Starrocks statement could not be closed: " + e.getMessage());
            } finally {
                statement = null;
            }
        }
